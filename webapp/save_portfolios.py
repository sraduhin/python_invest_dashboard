...
def save_portfolios(account_id, type, data, expected_yield, total_currencies, total_shares, total_etf, total_bonds, total_futures):
    portfolios = Portfolios(account_id=account_id, type=type, data=data,
